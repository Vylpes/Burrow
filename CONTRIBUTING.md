...
The following is a set of guidelines for contributing to Bolt. These are mostly guidelines, not rules. Use your best judgement, and feel free to propose changes to this document in a pull request.

## Code of Conduct

This project and everyone participating in it is governed by the Bolt Code of Conduct. By participating, you are expected to uphold this code.
...
You can also ask questions and submit ideas in our [discussions board](https://github.com/Vylpes/Bolt/discussions).

## What you should know

### Typescript and Node

Bolt uses [NodeJS](https://nodejs.org/), as well as TypeScript. You should know how to use this.
...
This section guides you through submitting a bug report for Bolt. Following these guidelines helps maintainers and the community understand your report. reproduce the behaviour, and find related reports.
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started Bolt (if you're using your own instance), which command exactly you used, and the output which the bot replied with. If its your own instance, provide information on what the terminal output said, if any.
...
* **Did the problem start happening recently** (e.g. after updating to a new version of Bolt) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of Bolt?** What's the most recently version in which the problem doesn't happen? You can download older versions of Bolt from the releases page.
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of Bolt are you using?** You can get the exact version by running the `about` command.
...
* **Are you running Bolt in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
...
This section guides you through submitting an enhancement suggestion for Bolt, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion and find related suggestions.
...
* **Include screnshots and animated GIFs** which help you demonstrate the steps or point out the part of Bolt which the suggestion is related to.
* **Explain why this enhancement would be useful** to most Bolt users and isn't something that can or should be implemented as a custom command.
* **List some other bots where this enhancement exists.**
* **Specify which version of Bolt you're using.** You can get the exact version by running the `about` command.
* **Specify the name and version of the OS you're using.**

### Your First Code Contribution

Unsure where to begin contributing to Bolt? You can start by looking through these `good first` and `help wanted` issues:

* [Good first issue](https://github.com/vylpes/Bolt/labels/good%20first%20issue) - issues which should only require a few lines of code, and a test or two.
* [Help wanted](https://github.com/vylpes/Bolt/labels/help%20wanted) - issues which should be a bit more involved than `good first` issues.
...
* Maintain Bolt's quality
* Fix problems that are important to users
* Engage the community in working toward the best possible Bolt
* Enable a sustainable system for Bolt's maintainers to review contributions
